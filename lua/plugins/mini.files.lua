return {
  {
    ...
    lazy = false, -- load at startup to be default explorer
    opts = {
      windows = {
        preview = true,
        width_focus = 30,
    ...
    keys = {
      ...
      -- Open mini.files at current file directory
      {
        "<leader>E",
        function()
    ...
    config = function(_, opts)
      ...
      -- Open file or folder in system default program / file manager
      local open_with_default_app = function()
